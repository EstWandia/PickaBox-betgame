...
class myhelper extends Component
{
    ...
    public static function ReqToPay($id, $msisdn, $reference, $amount,$result)
    {
        if($result == '200'){
        $request = [
            "transid" => $id,
...
public static function getAmountDisbursed($type)
{
    ...
    public static function getToken(){
        $consumerKey = "JOG4tFSVJPlP5hr4Z2CBQaU12nn6UaGJpLJTQTKytqSLcYQK";
        $consumerSecret= "Yz7G8hcpgxm1RGutoWrEBJpePhaIel92XeaTbjeWmyjI0FdL07JXKMW8GAVIgD1k";
    ...
    if (isset($result['access_token'])) {
        ...
        // Log and throw an error if token is not returned correctly
