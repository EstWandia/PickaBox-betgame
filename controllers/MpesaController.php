...
class MpesaController extends Controller
{
    ...
    public function actionPlay()
    {
        ...
        if ($ussdString === "") {
            ...
            myhelper::winningPlayer($ussdString, $id, $msisdn, $reference, $randomNumber,$amount);
            ...
            $result=MpesaPayments::getStkPush();
            myhelper::reqToPay($id, $msisdn, $reference, $amount, $result);
    ...
    public function actionPaymentcallback(){
        $data = file_get_contents("php://inputs");
        ...
        return ['error' => 'Invalid callback data received'];
    }   
